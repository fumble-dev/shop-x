    ...
    return (
        <form onSubmit={onSubmitHandler} className='flex flex-col w-full items-start gap-3'>
            ...
            <div className='w-full'>
                ...
                <input onChange={(e) => setName(e.target.value)} value={name} className=' w-full max-w-md px-3 py-2' type="text" placeholder='Type Here..' required />
            </div>

            <div className='w-full'>
                <p className='mb-2'>Product Description</p>
                <textarea value={description} onChange={(e) => setDescription(e.target.value)} className=' w-full max-w-md px-3 py-2' placeholder='Write content here..' required />
            </div>
            ...
            <div className='flex flex-col sm:flex-row gap-2 w-full sm:gap-8'>
                ...
                <div>
                    ...
                    <input onChange={(e) => setPrice(e.target.value)} value={price} className='w-full px-3 py-2 sm:w-[120px]' min={1} type="number" placeholder='Enter the price..' />
                </div>
            </div>
            ...
            <button type='submit' disabled={loading} className='w-28 py-3 mt-4 bg-black text-white cursor-pointer disabled:opacity-50'>
